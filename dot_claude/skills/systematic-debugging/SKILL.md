...
5Did it behave as predicted?
5. **Iterate or proceed** - Refine hypothesis if wrong, implement if right
...
- **testing-patterns**: Create test that reproduces the bug before fixing. **Verify results** -
